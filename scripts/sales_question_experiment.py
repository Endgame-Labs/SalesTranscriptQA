...
from salestranscriptqa.sales_questions import SalesQuestions, SalesQuestionsGLM, SALES_PROMPT, STYLE_AUDIT


def main():
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument('--model', choices=['deepseek', 'glm'], default='deepseek')
    ...
    cls = SalesQuestions if args.model == 'deepseek' else SalesQuestionsGLM
