...
from salestranscriptqa.natural import ScopedNatural, NATURAL_PROMPT, SCOPED_PROMPT
from salestranscriptqa.corpus import write_json

root=Path('runs/natural-pilot-v4-scoped')
full=ScopedNatural('data/corpus',root,workers=8)
original=json.loads(Path('reports/natural-pilot-v2.json').read_text())['questions']
write_json(root/'prompt.json',{'base':NATURAL_PROMPT,'scope':SCOPED_PROMPT})
...
write_json(Path('reports/natural-pilot-v4-scoped.json'),{'questions':rows,'estimated_usd':cost,
